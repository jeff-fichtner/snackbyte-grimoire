...
description: Inspect the real ClickUp workspace and propose a project-specific sync
  ruleset for approval; honored by sync when approved, else defaults apply
