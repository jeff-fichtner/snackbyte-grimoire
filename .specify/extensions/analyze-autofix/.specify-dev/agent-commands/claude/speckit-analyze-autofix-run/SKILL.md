---
name: speckit-analyze-autofix-run
description: Apply the unambiguous fixes from the analysis report, then re-present
  the analysis
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: analyze-autofix:commands/speckit.analyze-autofix.run.md
---
